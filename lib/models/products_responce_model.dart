...
//
//     final getProductResponceModel = getProductResponceModelFromJson(jsonString);

import 'dart:convert';

GetProductResponceModel getProductResponceModelFromJson(String str) => GetProductResponceModel.fromJson(json.decode(str));

String getProductResponceModelToJson(GetProductResponceModel data) => json.encode(data.toJson());

class GetProductResponceModel {
  final List<Product>? products;
  final int? total;
  final int? skip;
  final int? limit;

  GetProductResponceModel({
    this.products,
    this.total,
    this.skip,
    this.limit,
  ...
  factory GetProductResponceModel.fromJson(Map<String, dynamic> json) => GetProductResponceModel(
